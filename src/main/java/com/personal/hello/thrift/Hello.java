...
public class Hello {
  ...
  public interface Iface {
    ...
    public Map<Integer,String> helloMap(String u) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void helloMap(String u, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    {
      send_helloMap(u);
      return recv_helloMap();
    }

    public void send_helloMap(String u) throws org.apache.thrift.TException
    {
      helloMap_args args = new helloMap_args();
      args.setU(u);
      sendBase("helloMap", args);
    }

    public Map<Integer,String> recv_helloMap() throws org.apache.thrift.TException
    {
      helloMap_result result = new helloMap_result();
      receiveBase(result, "helloMap");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "helloMap failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void helloMap(String u, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      helloMap_call method_call = new helloMap_call(u, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class helloMap_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String u;
      public helloMap_call(String u, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.u = u;
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("helloMap", org.apache.thrift.protocol.TMessageType.CALL, 0));
        helloMap_args args = new helloMap_args();
        args.setU(u);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public Map<Integer,String> getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_helloMap();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("helloMap", new helloMap());
      return processMap;
    }
    ...
    public static class helloMap<I extends Iface> extends org.apache.thrift.ProcessFunction<I, helloMap_args> {
      public helloMap() {
        super("helloMap");
      }

      public helloMap_args getEmptyArgsInstance() {
        return new helloMap_args();
      }
      ...
      public helloMap_result getResult(I iface, helloMap_args args) throws org.apache.thrift.TException {
        helloMap_result result = new helloMap_result();
        result.success = iface.helloMap(args.u);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class helloMap<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, helloMap_args, Map<Integer,String>> {
      public helloMap() {
        super("helloMap");
      }
      ...
      public void start(I iface, helloMap_args args, org.apache.thrift.async.AsyncMethodCallback<Map<Integer,String>> resultHandler) throws TException {
        iface.helloMap(args.u,resultHandler);
      }
    }
...
;
  ...
  public static class helloMap_args implements org.apache.thrift.TBase<helloMap_args, helloMap_args._Fields>, java.io.Serializable, Cloneable, Comparable<helloMap_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("helloMap_args");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new helloMap_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new helloMap_argsTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.U, new org.apache.thrift.meta_data.FieldMetaData("u", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(helloMap_args.class, metaDataMap);
    }

    public helloMap_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public helloMap_args(helloMap_args other) {
      if (other.isSetU()) {
        this.u = other.u;
      }
    }

    public helloMap_args deepCopy() {
      return new helloMap_args(this);
    }
    ...
    public helloMap_args setU(String u) {
      this.u = u;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof helloMap_args)
        return this.equals((helloMap_args)that);
      return false;
    }

    public boolean equals(helloMap_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(helloMap_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("helloMap_args(");
      boolean first = true;
    ...
    private static class helloMap_argsStandardSchemeFactory implements SchemeFactory {
      public helloMap_argsStandardScheme getScheme() {
        return new helloMap_argsStandardScheme();
      }
    }

    private static class helloMap_argsStandardScheme extends StandardScheme<helloMap_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, helloMap_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, helloMap_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class helloMap_argsTupleSchemeFactory implements SchemeFactory {
      public helloMap_argsTupleScheme getScheme() {
        return new helloMap_argsTupleScheme();
      }
    }

    private static class helloMap_argsTupleScheme extends TupleScheme<helloMap_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, helloMap_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetU()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, helloMap_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.u = iprot.readString();
  ...
  public static class helloMap_result implements org.apache.thrift.TBase<helloMap_result, helloMap_result._Fields>, java.io.Serializable, Cloneable, Comparable<helloMap_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("helloMap_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.MAP, (short)0);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new helloMap_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new helloMap_resultTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
              ...
              new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(helloMap_result.class, metaDataMap);
    }

    public helloMap_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public helloMap_result(helloMap_result other) {
      if (other.isSetSuccess()) {
    ...
    public helloMap_result deepCopy() {
      return new helloMap_result(this);
    }
    ...
    public helloMap_result setSuccess(Map<Integer,String> success) {
      this.success = success;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof helloMap_result)
        return this.equals((helloMap_result)that);
      return false;
    }

    public boolean equals(helloMap_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(helloMap_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("helloMap_result(");
      boolean first = true;
    ...
    private static class helloMap_resultStandardSchemeFactory implements SchemeFactory {
      public helloMap_resultStandardScheme getScheme() {
        return new helloMap_resultStandardScheme();
      }
    }

    private static class helloMap_resultStandardScheme extends StandardScheme<helloMap_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, helloMap_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, helloMap_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class helloMap_resultTupleSchemeFactory implements SchemeFactory {
      public helloMap_resultTupleScheme getScheme() {
        return new helloMap_resultTupleScheme();
      }
    }

    private static class helloMap_resultTupleScheme extends TupleScheme<helloMap_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, helloMap_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, helloMap_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          {
